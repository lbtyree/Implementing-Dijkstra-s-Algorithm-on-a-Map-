...
public class Display extends JFrame {
  ...
  public static Graph<String> readGraph(String vertexFile, String edgeFile) {
    ...
    try {
      ...
      while ((line = vertexFileBr.readLine()) != null) {
        ...
        Vertex<String> vertex = new Vertex<>(cityname, x, y);
   ...
   */
  public Display() {
    setTitle("Data Structures Map Visualizer");
    ...
    graph = readGraph("ttrvertices.txt", "ttredges.txt");
    ...
    txtCityxytxt.setText("ttrvertices.txt");
    ...
    txtCitypairstxt.setText("ttredges.txt");
    ...
    btnDrawWeightedShortest.addMouseListener(new MouseAdapter() {
      ...
      public void mouseReleased(MouseEvent e) {
        ...
        List<Edge<String>> weightedPath = graph.getDijkstraPath(startCity, endCity);
  ...
  private void updateGraphPanel() {
    ...
    panel.overlayEdges.put("weighted", new LinkedList<Edge<String>>());
    panel.overlayEdges.put("unweighted", new LinkedList<Edge<String>>());
    panel.overlayEdges.put("mst", new LinkedList<Edge<String>>());
  ...
  public class GraphPanel extends JPanel {
    ...
    public HashMap<String, List<Edge<String>>> overlayEdges;

    public GraphPanel(Graph<String> graph) {
      this.graph= graph;
      overlayEdges = new HashMap<>();
      overlayEdges.put("weighted", new LinkedList<Edge<String>>());
      overlayEdges.put("unweighted", new LinkedList<Edge<String>>());
      overlayEdges.put("mst", new LinkedList<Edge<String>>());
    }
    ...
    public void paintGraph(Graphics g) {
      for (Vertex<String> v : graph.getVertices()) {
        for (Edge<String> edge : v.getEdges()) {
    ...
    public void paintVertex(Graphics g, Vertex v) {
      ...
      g2.drawString(v.toString(), x - v.toString().length() * 8 / 2, y + VERTEX_RADIUS / 2);
    }
